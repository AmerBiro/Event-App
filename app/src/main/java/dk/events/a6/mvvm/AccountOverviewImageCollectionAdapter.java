...
public class AccountOverviewImageCollectionAdapter extends RecyclerView.Adapter <AccountOverviewImageCollectionAdapter.ImageCollectionViewHolder> {

    private List<ImageCollectionModel> imageCollectionModels;
    private OnImageCollectionItemClicked onImageCollectionItemClicked;

    public AccountOverviewImageCollectionAdapter(OnImageCollectionItemClicked onImageCollectionItemClicked) {
