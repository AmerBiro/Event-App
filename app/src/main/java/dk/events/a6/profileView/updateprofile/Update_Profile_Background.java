        ...
        binding.checkMark.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (
                    ...
                    Toast.makeText(Update_Profile_Background.this, "One or more fields are empty", Toast.LENGTH_SHORT).show();
                    return;
                }
                else {
...
//                                    Toast.makeText(Update_Profile_Background.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(Update_Profile_Background.this, "Profile background updated successfully", Toast.LENGTH_SHORT).show();
