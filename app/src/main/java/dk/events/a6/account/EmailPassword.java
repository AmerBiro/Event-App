        ...
        binding.checkMark.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (
                    ...
                    Toast.makeText(EmailPassword.this, "One or more fields are empty", Toast.LENGTH_SHORT).show();
                    return;
                }
                else {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            dataRef.set(updateUser).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    Toast.makeText(EmailPassword.this, "Email is changed successfully", Toast.LENGTH_SHORT).show();
                                }
                            }).addOnFailureListener(new OnFailureListener() {
                                @Override
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(EmailPassword.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                }
                            });
                            Toast.makeText(EmailPassword.this, "Profile updated successfully", Toast.LENGTH_SHORT).show();
